...
pub fn apply_anti_fee_sniping(
    ...
    const FIFTY_PERCENT_PROBABILITY_RANGE: f64 = 0.5;
    const MIN_SEQUENCE_VALUE: u32 = 1;
    const TEN_PERCENT_PROBABILITY_RANGE: f64 = 0.1;
    ...
    if use_locktime {
        ...
        if random_bool(TEN_PERCENT_PROBABILITY_RANGE) {
        ...
        let random_index = random_range(0..taproot_inputs.len());
